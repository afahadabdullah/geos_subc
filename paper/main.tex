...
Ensemble-generation properties are evaluated separately: member-count subsampling experiments quantify how CRPS and RMSE skill converge with the number of generated members, with member-resampling uncertainty bands from repeated random subsets.
