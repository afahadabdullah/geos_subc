#!/bin/bash
#SBATCH -J SA_nog_tgen
#SBATCH -o ml_output_flowmulti_v9_sa_55e100e_0n40n_noisectx_t2mres_nogeos/generate_testmode_%j.log
#SBATCH -e ml_output_flowmulti_v9_sa_55e100e_0n40n_noisectx_t2mres_nogeos/generate_testmode_%j.log
#SBATCH -p gh-dev
#SBATCH -N 1
#SBATCH -n 1
#SBATCH -t 02:00:00
...
echo "🚀 South Asia v9 no-GEOS test-mode-equivalent Zarr generation started at $(date) on $(hostname)"
...
CONFIG_PATH="${SA_TESTGEN_CONFIG:-ml_model/config_flow_multiv9_nogeos.yaml}"
...
OUT_DIR="${SA_TESTGEN_OUT_DIR:-dataprocess/gen_multiv9_sa_55e100e_0n40n_junjul_testmode_nogeos_e100_s50}"
...
if [ "$CONFIG_OUTPUT_DIR" != "ml_output_flowmulti_v9_sa_55e100e_0n40n_noisectx_t2mres_nogeos" ]; then
