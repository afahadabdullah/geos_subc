#!/bin/bash
#SBATCH -J test_flowmulti_v2
#SBATCH -o ml_output_flowmulti_v2/test_flowmulti_%j.log
#SBATCH -e ml_output_flowmulti_v2/test_flowmulti_%j.log
#SBATCH -p gh-dev
#SBATCH -N 1
#SBATCH -n 1
#SBATCH -t 02:00:00
...
accelerate launch --num_processes 1 --mixed_precision fp16 \
    ml_model/train_flow_multiv2.py \
    --config "$CONFIG_PATH" \
    --test \
    --ckpt "$CKPT_FILE"
