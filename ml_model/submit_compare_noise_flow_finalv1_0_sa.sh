#!/bin/bash
#SBATCH -J SA_noise_flow_finalv1_0
#SBATCH -o ml_output_noise_compare_sa_flow_finalv1_0/compare_noise_%j.log
#SBATCH -e ml_output_noise_compare_sa_flow_finalv1_0/compare_noise_%j.log
#SBATCH -p gh-dev
#SBATCH -N 1
#SBATCH -n 1
#SBATCH -t 02:00:00
...
echo "🚀 South Asia flow_finalv1.0 noise comparison started at $(date) on $(hostname)"
...
mkdir -p ml_output_noise_compare_sa_flow_finalv1_0

CONFIG_PATH="${SA_NOISE_CONFIG:-ml_model/config_flow_finalv1_0.yaml}"
...
python ml_model/compare_noise_flow_finalv1_0_sa.py \
    --config "$CONFIG_PATH" \
    --year "$YEAR" \
...
echo "🏁 South Asia flow_finalv1.0 noise comparison finished at $(date)"
