#!/bin/bash
#SBATCH -J SA_v9_3_tgen
#SBATCH -o ml_output_flowmulti_v9_3_sa_55e100e_0n40n_noisectx_t2mres/generate_testmode_%j.log
#SBATCH -e ml_output_flowmulti_v9_3_sa_55e100e_0n40n_noisectx_t2mres/generate_testmode_%j.log
#SBATCH -p gh-dev
#SBATCH -N 1
#SBATCH -n 1
#SBATCH -t 02:00:00
...
echo "🚀 South Asia v9.3 test-mode-equivalent Zarr generation started at $(date) on $(hostname)"
...
CONFIG_PATH="${SA_TESTGEN_CONFIG:-ml_model/config_flow_multiv9_3.yaml}"
...
OUT_DIR="${SA_TESTGEN_OUT_DIR:-dataprocess/gen_multiv9_3_sa_55e100e_0n40n_junjul_testmode_e100_s50}"
...
if [ "$CONFIG_OUTPUT_DIR" != "ml_output_flowmulti_v9_3_sa_55e100e_0n40n_noisectx_t2mres" ]; then
...
python ml_model/generate_forecast_zarr_multiv9_3_sa_testmode.py \
    --config "$CONFIG_PATH" \
...
echo "🏁 South Asia v9.3 test-mode-equivalent Zarr generation finished at $(date)"
