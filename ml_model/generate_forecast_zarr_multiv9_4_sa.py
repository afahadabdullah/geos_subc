#!/usr/bin/env python3
"""
Generate South Asia multi-v9.4 ensemble forecasts and save yearly Zarr stores.
...
DEFAULT_OUT_DIR = "dataprocess/gen_multiv9_4_sa_55e100e_0n40n_junjul_e10clim_e100eval_s50"
...
def main():
    ...
    print("\n" + "=" * 88)
    print("South Asia v9.4 forecast Zarr generation")
