...
HEAD_BOTTLENECK = 32
CONTEXT_HIDDEN = 128
# Default v4 width: only widen the deepest stage so we gain bottleneck capacity
...
class FlowMatchingModel(nn.Module):
    ...
    v4 keeps the same external interface as multiv1, but improves how lead and
    ...
    def __init__(self, in_channels=37, out_channels=2, block_out_channels=None):
        ...
        self.unet = UNet2DModel(
            ...
            layers_per_block=2,
            # A modest v4 widening: only the deepest stage grows beyond v1 by
