...
python3 ml_model/test_flow.py --config ml_model/config_flow.yaml --ckpt /home1/11353/afahad/geos_subc/ml_output_flow2/latest_flow_ckpt.pt --year 2015 --ensemble-size 20
