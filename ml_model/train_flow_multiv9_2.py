...
from flow_matching_multi_v9_2 import FlowMatchingModel, CustomFlowMatcher
import noise_utils
...
def select_geos_condition(x_geos, lead_idx, lead_selective_geos=True):
    ...
    v9.2 uses only the GEOS forecast lead matching each training sample. Set
...
def train(args, accelerator):
    ...
    if accelerator.is_main_process:
        ...
        print(f"   --- v9 Conditioning Upgrades ---")
    ...
    metrics_log_file = os.path.join(output_dir, "validation_metrics_v9_2.csv")
