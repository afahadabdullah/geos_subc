#!/usr/bin/env python3
"""
Generate global flow_finalv1_global ensemble forecasts exactly like test mode.

Unlike generate_forecast_zarr_flow_finalv1_global.py, this script creates the full
EOF-LHS/random mixed ensemble noise for each batch before chunking the ODE solve.
That matches train_flow_finalv1_global.run_full_test_suite_multi and avoids changing
...
DEFAULT_OUT_DIR = "dataprocess/gen_flow_finalv1_global_junjul_testmode_e100_s50"
...
def main():
    ...
    print("\n" + "=" * 88)
    print("Global flow_finalv1_global forecast Zarr generation (test-mode equivalent)")
