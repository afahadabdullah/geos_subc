...
def calculate_global_stats(data_root, out_path="v5_global_stats.pt", batch_size=32):
...
if __name__ == "__main__":
    ...
    parser.add_argument("--data_root", type=str, default="/home1/11353/afahad/geos_subc/dataprocess")
    parser.add_argument("--out", type=str, default="ml_model/v5_global_stats.pt")
