#!/bin/bash
#SBATCH -J SA_test_nog
#SBATCH -o ml_output_flowmulti_v9_sa_55e100e_0n40n_noisectx_t2mres_nogeos/test_%j.log
#SBATCH -e ml_output_flowmulti_v9_sa_55e100e_0n40n_noisectx_t2mres_nogeos/test_%j.log
#SBATCH -p gh-dev
#SBATCH -N 1
#SBATCH -n 1
#SBATCH -t 02:00:00
...
echo "🧪 South Asia Multi-v9 no-GEOS-input full test started at $(date) on $(hostname)"
...
CONFIG_PATH="${SA_TEST_CONFIG:-ml_model/config_flow_multiv9_nogeos.yaml}"
...
EXPECTED_OUTPUT_DIR="ml_output_flowmulti_v9_sa_55e100e_0n40n_noisectx_t2mres_nogeos"
...
echo "🏁 South Asia Multi-v9 no-GEOS-input full test finished at $(date)"
