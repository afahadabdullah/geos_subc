#!/usr/bin/env python3
"""Fail-fast verification of flow_finalv1.0 targets and GEOS statistics."""
...
from dataset_flow_stats_finalv1_0 import S2SHybridDataset as ReferenceDataset
...
def parse_args():
    parser = argparse.ArgumentParser(
        description="Verify flow_finalv1.0 GEOS statistics without changing reference targets."
    )
    parser.add_argument("--config", default="ml_model/config_flow_finalv1_0.yaml")
...
def main():
    ...
    print("PASS: flow_finalv1.0 target/predictor equivalence and GEOS statistics")
