#!/bin/bash
#SBATCH -J calc_stats_multi         # Job name
#SBATCH -o ml_output_flow6/stats_multi_%j.log
#SBATCH -e ml_output_flow6/stats_multi_%j.log
...
echo "🔥 Launching Global Statistics Calculation (Multi-Target v1)..."
