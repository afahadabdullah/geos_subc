#!/usr/bin/env python3
"""
South Asia v9.5b checkpoint sweep under pure random noise.
...
from dataset_flow_multi_v9_5b import S2SHybridDataset
...
def main():
    parser = argparse.ArgumentParser(description="Compare SA v9.5b checkpoints under pure random noise.")
    ...
    print("\n" + "=" * 96)
    print("South Asia v9.5b checkpoint sweep: pure random noise only")
