#!/usr/bin/env python3
"""
South Asia v9.4 checkpoint sweep under pure random noise.
...
def main():
    parser = argparse.ArgumentParser(description="Compare SA v9.4 checkpoints under pure random noise.")
    ...
    print("\n" + "=" * 96)
    print("South Asia v9.4 checkpoint sweep: pure random noise only")
