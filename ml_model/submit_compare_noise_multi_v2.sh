#!/bin/bash
#SBATCH -J cmp_noise_multi_v2          # Job name
#SBATCH -o ml_output_flowmulti_v2/cmp_noise_multi_%j.log
#SBATCH -e ml_output_flowmulti_v2/cmp_noise_multi_%j.log
...
echo "Starting multi-variate noise comparison (multi v2)..."
date
...
python3 ml_model/compare_noise_multi_v2.py \
    --output_dir ml_output_flowmulti_v2 \
    --year 2021 \
    --num_ensemble 30 \
    --num_steps 10
