#!/bin/bash
#SBATCH -J SA_v9_nogeos
#SBATCH -o ml_output_flowmulti_v9_sa_55e100e_0n40n_noisectx_t2mres_nogeos/flow_%j.log
#SBATCH -e ml_output_flowmulti_v9_sa_55e100e_0n40n_noisectx_t2mres_nogeos/flow_%j.log
...
echo "🚀 South Asia Multi-v9 no-GEOS-input ablation training job started at $(date) on $(hostname)"
...
CONFIG_PATH="${SA_TRAIN_CONFIG:-ml_model/config_flow_multiv9_nogeos.yaml}"
...
if [ "$CONFIG_OUTPUT_DIR" != "ml_output_flowmulti_v9_sa_55e100e_0n40n_noisectx_t2mres_nogeos" ] || [ "$CONFIG_TARGET_DOMAIN" != "south_asia" ]; then
...
echo "🔥 Launching Flow Matching Multi-Target v9 Training (SA no-GEOS ablation, local/global predictors, residual T2M)..."
