...
def train(args, accelerator):
    ...
    if accelerator.is_main_process:
        ...
        print(f"   Total Input Channels: 34")
        print(f"   --- Condition Channels (x_cond = 33) ---")
        ...
        print(f"     [24-27] x_geos: GEOS Precipitation Forecast (L=1 to 4)")
        ...
        print(f"     [    31] MJO Phase: RMM1_lagged")
        print(f"     [    32] MJO Phase: RMM2_lagged")
