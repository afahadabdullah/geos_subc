...
HEAD_BOTTLENECK = 32
CONTEXT_HIDDEN = 128
# Default v7 width: only widen the deepest stage so we gain bottleneck capacity
...
class FlowMatchingModel(nn.Module):
    ...
    v7 keeps the v4 external interface, while training T2M as a GEOS-residual
    ...
    def __init__(
        ...
        self.unet = UNet2DModel(
            ...
            layers_per_block=2,
            # A modest v7 widening: only the deepest stage grows beyond v1 by
