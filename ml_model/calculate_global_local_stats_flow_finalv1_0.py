#!/usr/bin/env python3
"""
Build normalization statistics for the flow_finalv1.0 South Asia model.

The release normalization file intentionally mixes two scopes:
...
from dataset_flow_stats_finalv1_0 import S2SHybridDataset
...
def calculate_stats(data_root, out_path, start_year, end_year, batch_size, target_domain, target_domain_bounds):
    ...
    print("\n==================================")
    print(f"Calculated flow_finalv1.0 Global/Local Bounds ({start_year}-{end_year})")
    print("==================================")
    for key, value in bounds.items():
    ...
    print(f"\nSaved flow_finalv1.0 stats to {out_path}!")
...
def main():
    ...
    parser.add_argument("--out", type=str, default="ml_model/flow_finalv1_0_sa_55e100e_0n40n_global_local_stats.pt")
