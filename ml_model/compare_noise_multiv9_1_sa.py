...
from train_flow_multiv9_1 import (
    compute_crps,
    compute_rmse,
...
EXPECTED_OUTPUT_DIR = "ml_output_flowmulti_v9_1_sa_55e100e_0n40n_noisectx_t2mres"
...
def parse_args():
    parser = argparse.ArgumentParser(description="Compare SA multi-v9.1 local/global noise strategies.")
...
def validate_current_sa_v9_config(config, output_dir):
    ...
    if zero_geos:
        raise ValueError("v9.1 SA is the GEOS-conditioned residual-T2M workflow; zero_geos_condition must be False")
