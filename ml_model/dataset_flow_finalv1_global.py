...
# flow_finalv1_global GEOS conditioning order. The first axis of x_geos is now a statistic
...
class S2SHybridDataset(Dataset):
    ...
    def _load_sample(self, idx, handles=None, cached_common=None, return_common_only=False):
        ...
        if cached_common is not None:
            ...
            # flow_finalv1_global conditions on target-lead ensemble distribution summaries.
            ...
            if self.normalize and self.bounds is not None:
                ...
                # established GEOS mean channels.
