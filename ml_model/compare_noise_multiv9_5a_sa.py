#!/usr/bin/env python3
"""
South Asia noise-strategy comparison for the multi-target v9.5a flow model.
...
loads the v9.5a local/global model class, and writes side-by-side GEOS / random / EOF-LHS
metrics to CSV.
"""
...
from dataset_flow_multi_v9_5a import GEOS_CONDITION_STATISTICS, S2SHybridDataset
...
EXPECTED_OUTPUT_DIR = "ml_output_flowmulti_v9_5a_sa_55e100e_0n40n_noisectx_t2mres"
...
def parse_args():
    parser = argparse.ArgumentParser(description="Compare SA multi-v9.5a local/global noise strategies.")
...
def validate_current_sa_v9_config(config, output_dir):
    ...
    if zero_geos:
        raise ValueError("v9.5a SA is the GEOS-conditioned residual-T2M workflow; zero_geos_condition must be False")
