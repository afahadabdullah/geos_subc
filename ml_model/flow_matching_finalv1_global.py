...
# Release width: only widen the deepest stage so we gain bottleneck capacity
...
class FlowMatchingModel(nn.Module):
    ...
    def __init__(
        ...
        if int(out_channels) != 2:
            raise ValueError("flow_finalv1_global separate PR/T2M heads require out_channels=2.")
