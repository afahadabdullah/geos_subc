#!/usr/bin/env python3
"""
South Asia flow_finalv1.0 checkpoint sweep under pure random noise.
...
from dataset_flow_finalv1_0 import S2SHybridDataset
...
def main():
    parser = argparse.ArgumentParser(description="Compare SA flow_finalv1.0 checkpoints under pure random noise.")
    ...
    print("\n" + "=" * 96)
    print("South Asia flow_finalv1.0 checkpoint sweep: pure random noise only")
