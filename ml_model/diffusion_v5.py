...
class DiffusionModelV5(nn.Module):
    """
    Wrapper for diffusers.UNet2DModel that maintains the V5 spatial conditioning API.
    ...
    def forward(self, x_noisy, x_cond, timestep):
        ...
        x = torch.cat([x_noisy, x_cond], dim=1) # [B, 32, H, W]
