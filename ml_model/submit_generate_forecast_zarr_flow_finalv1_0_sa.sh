#!/bin/bash
#SBATCH -J SA_flow_finalv1_0_zarr
#SBATCH -o ml_output_flow_finalv1_0_sa_55e100e_0n40n_noisectx_t2mres/generate_zarr_%j.log
#SBATCH -e ml_output_flow_finalv1_0_sa_55e100e_0n40n_noisectx_t2mres/generate_zarr_%j.log
#SBATCH -p gh-dev
#SBATCH -N 1
#SBATCH -n 1
#SBATCH -t 02:00:00
...
echo "🚀 South Asia flow_finalv1.0 forecast Zarr generation started at $(date) on $(hostname)"
...
CONFIG_PATH="${SA_GEN_CONFIG:-ml_model/config_flow_finalv1_0.yaml}"
...
OUT_DIR="${SA_GEN_OUT_DIR:-dataprocess/gen_flow_finalv1_0_sa_55e100e_0n40n_junjul_e10clim_e100eval_s50}"
...
python ml_model/generate_forecast_zarr_flow_finalv1_0_sa.py \
    --config "$CONFIG_PATH" \
...
echo "🏁 South Asia flow_finalv1.0 forecast Zarr generation finished at $(date)"
