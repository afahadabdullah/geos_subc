...
from flow_matching_multi_v8 import FlowMatchingModel, CustomFlowMatcher
import noise_utils
...
def decode_t2m_forecast_from_norm(
    ...
    v8 can train channel 1 as a GEOS-residual target:
...
def train(args, accelerator):
    ...
    if crps_loss and t2m_target_mode == "geos_residual":
        raise ValueError(
            "crps_loss=True is not wired for v8 residual T2M targets yet. "
    ...
    if accelerator.is_main_process:
        ...
        print(f"   --- v8 Conditioning Upgrades ---")
    ...
    log_file = os.path.join(output_dir, "training_log_v8.csv")
    ...
    if accelerator.is_main_process:
        ...
        # In v8 residual mode, y_target C=1 is normalized ERA5 minus GEOS-mean.
