...
class FlowMatchingModel(nn.Module):
    ...
    v8 keeps the v4 external interface, while training T2M as a GEOS-residual
    target in the surrounding data/training pipeline.
    """
    ...
    def __init__(
        ...
        self.unet = UNet2DModel(
            ...
            layers_per_block=2,
            # A modest v8 widening: only the deepest stage grows beyond v1 by
...
class CustomFlowMatcher:
    ...
    def sample_time_batch(
        ...
        uniform keeps the predecessor behavior. stratified_low_mid puts more
        training mass near early/mid denoising while preserving late-time
        coverage, which is useful for climate fields with sharp PR structure.
        """
