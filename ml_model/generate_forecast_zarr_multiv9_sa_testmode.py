#!/usr/bin/env python3
"""
Generate South Asia multi-v9 ensemble forecasts exactly like v9 test mode.
...
DEFAULT_OUT_DIR = "dataprocess/gen_multiv9_sa_55e100e_0n40n_junjul_testmode_e100_s50"


def parse_args():
    parser = argparse.ArgumentParser(description="Generate multi-v9 SA forecasts to yearly Zarr stores.")
...
def main():
    ...
    print("\n" + "=" * 88)
    print("South Asia v9 forecast Zarr generation (test-mode equivalent)")
