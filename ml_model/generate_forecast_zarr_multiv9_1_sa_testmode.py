#!/usr/bin/env python3
"""
Generate South Asia multi-v9.1 ensemble forecasts exactly like v9 test mode.

Unlike generate_forecast_zarr_multiv9_1_sa.py, this script creates the full
EOF-LHS/random mixed ensemble noise for each batch before chunking the ODE solve.
That matches train_flow_multiv9_1.run_full_test_suite_multi and avoids changing
...
from compare_noise_multiv9_1_sa import (
    decode_multi,
    load_noise_context,
    resolve_checkpoint,
...
from flow_matching_multi_v9_1 import CustomFlowMatcher, FlowMatchingModel
from train_flow_multiv9_1 import euler_solve_chunked, get_batch_global_context


DEFAULT_OUT_DIR = "dataprocess/gen_multiv9_1_sa_55e100e_0n40n_junjul_testmode_e100_s50"


def parse_args():
    parser = argparse.ArgumentParser(description="Generate multi-v9.1 SA forecasts to yearly Zarr stores.")
    parser.add_argument("--config", type=str, default="ml_model/config_flow_multiv9_1.yaml")
...
def main():
    ...
    print("\n" + "=" * 88)
    print("South Asia v9.1 forecast Zarr generation (test-mode equivalent)")
